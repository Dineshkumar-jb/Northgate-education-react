  ...
  return (
    <section id="exams">
      ...
      <div className="exams-grid">
        ...
        <div className="exam-card fade-up sat-card" onClick={onOpenSatModal}>
        ...
        {/* IELTS */}
        <div
          className={`exam-card fade-up ${openExams.ielts ? 'open' : ''}`}
        ...
        {/* TOEFL */}
        <div
          className={`exam-card fade-up ${openExams.toefl ? 'open' : ''}`}
        ...
        {/* CAE */}
        <div
          className={`exam-card fade-up ${openExams.cae ? 'open' : ''}`}
          onClick={() => toggleExam('cae')}
        >
          <div className="exam-badge">
        ...
        {/* Duolingo */}
        <div
          className={`exam-card fade-up ${openExams.duolingo ? 'open' : ''}`}
          onClick={() => toggleExam('duolingo')}
        >
          <div className="exam-badge">
